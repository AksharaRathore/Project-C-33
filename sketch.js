...
function setup() {
  ...
  bubble = createSprite(285,480,20,20);
...
function draw() 
{
  ...
  if(collide(fruit,bunny,85)==true)
  {
    ...
    if(fruit!=null && fruit.position.y>=750)
  {
   ...
   textSize(25);
   fill("cyan")
   text("Cut the rope to feed the Bunny",width/7,height/4);
